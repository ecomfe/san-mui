...
export default san.defineComponent({
    ...
    template: `
        <div class="{{className}}" style="{{style}}">
            <div san-if="{{showArrow}}" class="{{arrowClassName}}"></div>
            <div class="inner">
                <slot></slot>
            </div>
        </div>
    ...
    computed: {
        className() {
            ...
            return cx(
                'sm-popover',
                this.data.get('placement'),
                open ? 'show' : 'hide-popover',
                {
                    'animation': this.data.get('animation'),
                    'no-arrow': !this.data.get('showArrow')
                }
            );
        },
        style() {
            return {
                left: `${this.data.get('posLeft')}px`,
                top: `${this.data.get('posTop')}px`
            };
        },
        arrowClassName() {
            return cx('arrow', `arrow-${this.data.get('placement')}`);
        }
    },
