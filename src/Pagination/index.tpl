    ...
    <div class="sm-pagination-inner" san-if="total">
        ...
        <div class="page-size-selector{{ pageSizePopupOpen ? ' open' : '' }}" san-if="showSizeChanger">
            ...
            <section class="selector-popup">
                <section san-for="pageSizeItem in pageSizeOptions" class="page-size-item{{ pageSizeItem === pageSize ? ' active' : '' }}" on-click="changePageSize(pageSizeItem)">{{ pageSizeItem }} / 页</section>
            </section>
        </div>
    </div>
</div>
