...
describe('TextField', () => {
    ...
    it('simple use', done => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" hintText="提示文字"/></div>'
        });
    ...
    it('use label', done => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" label="标签文字" labelFocusClass="focusClass"/></div>'
        });
        let el = component.ref('input').el;
        let inputElement = el.querySelector('input');
    ...
    it('use float label', done => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" labelFloat label="标签文字"/></div>'
        });
        let el = component.ref('input').el;
        let inputElement = el.querySelector('input');
        let labelElement = el.querySelector('.sm-text-field-label');
    ...
    it('set type', () => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" type="password" label="标签文字"/></div>'
        });
        let el = component.ref('input').el;
        let inputElement = el.querySelector('input');
        expect(el.tagName).to.equal('DIV');
    ...
    it('set full width', () => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" fullWidth label="标签文字"/></div>'
        });
        let el = component.ref('input').el;
    ...
    it('error text', () => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" hintText="标签文字" errorText="错误文字"/></div>'
        });
        let el = component.ref('input').el;
        let focusLineElement = el.querySelector('.sm-text-field-focus-line');
    ...
    it('error color', () => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" hintText="标签文字" errorText="错误文字" errorColor="#2196f3"/></div>'
        });
        let el = component.ref('input').el;
        let focusLineElement = el.querySelector('.sm-text-field-focus-line');
        expect(el.classList.contains('error')).to.equal(true);
    ...
    it('disabled input', () => {
        let component = createComponent({
            template: '<div><ui-input s-ref="input" hintText="提示文字" disabled/></div>'
        });
        let input = component.ref('input');
